 ...
 */
export declare class VaultLockedOutError extends Error {
 ...
 */
export declare const BIOMETRIC_REJECTION_REASONS: readonly ["cancelled", "retries-exhausted", "device-locked", "not-found"];
export type BiometricRejectionReason = (typeof BIOMETRIC_REJECTION_REASONS)[number] | 'unknown';
/**
...
export declare class BiometricUnavailableError extends Error {
    readonly code = "BIOMETRIC_UNAVAILABLE";
    constructor(message?: string);
}
export declare class BiometricCodeRejectedError extends Error {
 ...
 */
export declare class BiometricNonDeterministicError extends Error {
